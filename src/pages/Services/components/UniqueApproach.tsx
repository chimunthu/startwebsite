...
import { approaches } from '../data/approachData';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            A abordagem "Braço, Cérebro, Bolso" é uma estratégia abrangente adotada pela Start Space 
            para impulsionar ideias e fomentar talentos no cenário empreendedor de Moçambique.
          </p>
        </div>
          ...
          {approaches.map((approach, index) => (
            <div key={index} className="relative group">
              ...
              <div className="aspect-square rounded-full bg-white shadow-lg hover:shadow-xl transition-all duration-300 p-8 flex flex-col items-center justify-center text-center relative overflow-visible group-hover:-translate-y-2">
                ...
                {/* Icon Container - Positioned at the bottom */}
